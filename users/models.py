...
class User(AbstractUser):
    ...
    avatar = models.ImageField(upload_to='avatars/', default='https://res.cloudinary.com/dmhb7l2xl/image/upload/v1743790870/default-boy-avatar_mca8ah.jpg', null=True)
